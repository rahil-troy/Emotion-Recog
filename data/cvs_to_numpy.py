...
index = 1
total = data.shape[0]
print "the total number of images is:",total

for index, row in data.iterrows():
    if row['emotion'] in [0,3,6]:
      print(row['emotion'])
      emotion = emotion_to_vec(row['emotion'] )
    #print "the emotions are:: ",emotion
...
np.save('data_set_training.npy', images)
np.save('labels_set_training.npy', labels)
