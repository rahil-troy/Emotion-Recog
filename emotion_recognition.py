...
class EmotionRecognition:
  ...
  def build_network(self):
    ...
    self.model = tflearn.DNN(self.network,checkpoint_path = SAVE_DIRECTORY + '/EmotionRecognition_recognition',max_checkpoints = 1,tensorboard_verbose = 2)
    self.load_model()
  ...
  def start_training(self):
    ...
    self.model.fit(self.dataset.images, self.dataset.labels,validation_set = 0.2,n_epoch = 100,batch_size = 100,shuffle = True,show_metric = True,snapshot_step = 200,snapshot_epoch = True,run_id = 'emotion_recognition')
